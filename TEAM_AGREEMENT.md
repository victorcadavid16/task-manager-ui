...
| :--- | :--- | :--- |
| [victor cadavid] | Líder (Arquitecto) | `@victorcadavid16` |
| [Yury Mantilla] | Desarrollador | `@yury1907` |
| [Luisa León] | Desarrollador | `@LLEON17` |

## 2. Canales de Comunicación
Para mantener el orden y separar lo profesional de lo personal, usaremos los siguientes canales:
* **Comunicación Oficial y Archivos:** [Ej: Grupo de WhatsApp]
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días [Miercoles] a las [1:00 pm] de forma [Virtual].
* **Tiempo máximo de respuesta:** Nos comprometemos a responder mensajes del equipo en un máximo de [Ej: 1 Hora] durante el horario hábil.
...
1. **Ausencias:** Si alguien no puede trabajar por fuerza mayor, debe avisar por el canal oficial con al menos 1 hora de anticipación para reasignar sus tareas.
...
3. **Decisiones Técnicas:** En caso de desacuerdo sobre cómo programar algo, se debatirá con argumentos técnicos y la decisión final será tomada por todos.
